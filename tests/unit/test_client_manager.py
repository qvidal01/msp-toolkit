...
from msp_toolkit.core.models import ClientStatus, ClientTier
...
class TestClientManager:
    ...
    def test_create_client_rejects_invalid_tier(self, test_config):
        """Invalid tier values should raise validation errors."""
        manager = ClientManager(test_config)

        with pytest.raises(ValidationError):
            manager.create("acme-corp", name="Acme Corp", tier="diamond")
